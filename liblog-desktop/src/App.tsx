...
function renderPage(page: PageId) {
  switch (page) {
    ...
    case 'patrons':      return (
      <div style={{ padding: '0' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 700, color: '#1a1a2e', marginBottom: '8px' }}>Patron Management</h1>
        <p style={{ color: '#9ca3af' }}>PatronManager component — coming in Phase 2.</p>
      </div>
    );
